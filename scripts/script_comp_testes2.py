...
dataset_V12_SR = pd.read_csv(path_file + 'V12_SimpleReset_Ambiguidade_iteracao.csv')
dataset_V12_RB = pd.read_csv(path_file + 'V12_RetreinaTodosComBufferWarning_Ambiguidade_iteracao.csv')
dataset_DDM = pd.read_csv(path_file + 'DDM_Original_iteracao.csv')
dataset_LB = pd.read_csv(path_file + 'LB_Original_iteracao.csv')


X = dataset_V12_SR['iteracao'].values;

Y_V12_SR = dataset_V12_SR['taxa'].values;
Y_V12_RB = dataset_V12_RB['taxa'].values;
...
def test_nemenyi():
    data = np.asarray([Y_V12, Y_DDM, Y_LB])
