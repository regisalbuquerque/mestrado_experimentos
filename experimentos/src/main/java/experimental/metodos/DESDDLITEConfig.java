...
import br.ufam.metodos.v13.MetodoClassificadorV13LITE;
import br.ufam.metodos.v14.MetodoClassificadorV14LITE;
import experimental.model.MetodoFactory;
import experimentos.config.Configuracoes;

public class DESDDLITEConfig implements MetodoTeste{

	private DESDDClassifierLITE desddClassifier;
    ...
    public DESDDLITEConfig(String versao, String geracao, String reacao, String medida, int randomSeed, String detectorOpt, int numBaseLeaners)
    {
    ...
    public DESDDLITEConfig(DESDDClassifierLITE desddClassifier, String versao, String geracao, String reacao, String medida, int randomSeed, String detectorOpt, int numBaseLeaners)
    {
    ...
    public MetodoFactory getMetodo() {
    	...
    	DESDDClassifierLITE metodoClassificadorDESDD = null;
    	...
    	else
    	{
	    	switch (versao) {
			case "12":
				metodoClassificadorDESDD = new MetodoClassificadorV12LITE();
				MetodoClassificadorV12LITE v12 = (MetodoClassificadorV12LITE) metodoClassificadorDESDD;
				v12.lambdasOption.setValueViaCLIString("100,50,10,5,1,0.5,0.1,0.05,0.01,0.005,0.001");
				break;
			case "13":
				metodoClassificadorDESDD = new MetodoClassificadorV13LITE();
				MetodoClassificadorV13LITE v13 = (MetodoClassificadorV13LITE) metodoClassificadorDESDD;
				...
				break;
			case "14":
				metodoClassificadorDESDD = new MetodoClassificadorV14LITE();
				MetodoClassificadorV14LITE v14 = (MetodoClassificadorV14LITE) metodoClassificadorDESDD;
