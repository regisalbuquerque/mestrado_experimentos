 ...
 * @author regis
 */
public class BaseAgrawalGradual implements BaseFactory{
    
    Base base = new Base("AgrawalGradual", "AgrawalGradual", "src/main/resources/dados/agrawal_gradual.arff", 10000, false);
