...
public class Configuracoes {
    ...
    final static String PATH_DATE = "171017_4";
    ...
    public static String PATH_COMPARACAO = PATH_BASE + "comparacao3/";
    public static String PATH_PARETO_METODO = PATH_BASE + "comparacao3/pareto/";
    ...
    public static String PATH_REACAO_ITERACOES = "/home/regis/Documents/git/regis/mestrado/texto/experimentos/" + PATH_DATE + "/metodos/reacao/iteracoes/";
